...
<script>
import {postArticleSubmitComment,postArticleCommentList,deleteComment,postArticleInfo,postArticleReadUser} from '@/api/article';
...
export default {
  ...
  methods:{
    ...
    logEdit(){
      var $this = this;      
      var routeUrl =  $this.$router.resolve({path:'/Article/addEdit',query:{id:$this.currentID}});
