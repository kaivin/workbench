<template>
  <div class="page-root" ref="boxPane">
    ...
    <el-dialog title="分配角色" v-if="(menuButtonPermit.includes('Chinaphone_getrole'))&&device==='desktop'" custom-class="transfer-dialog" :visible.sync="dialogRoleVisible" width="840px">
