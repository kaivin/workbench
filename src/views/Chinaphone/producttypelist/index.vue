...
<script>
import {getProductTypeList,productTypeDelete,productTypeEdit,productTypeAdd} from '@/api/chinaphone';
...
export default {
  ...
  methods:{
    ...
    handleClose(){
      ...
      $this.$store.dispatch('app/closeCnCate');
    },
    // 添加表格行数据
