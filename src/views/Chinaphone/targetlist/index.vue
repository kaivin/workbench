<template>
  <div class="page-root SaleCard" ref="boxPane">
                    ...
                    <div class="card-content" ref="tableContent">
                      <div class="table-wrapper" v-bind:class="scrollPosition.isFixed?'fixed-table':''">
                          ...
                          <el-table
                              ...
                              <el-table-column
                                v-if="(menuButtonPermit.indexOf('Chinaphone_targetlistedit')||menuButtonPermit.indexOf('Chinaphone_targetlistdelete'))&&device==='desktop'"
                                ...
                                <template #default="scope">
                                  <div class="table-button">
                                    <el-button size="mini" @click="editTableRow(scope.row,scope.$index)" v-if="menuButtonPermit.includes('Chinaphone_targetlistedit')">编辑</el-button>
                                    <el-button size="mini" @click="deleteTableRow(scope.row,scope.$index)" v-if="menuButtonPermit.includes('Chinaphone_targetlistdelete')" type="info" plain>删除</el-button>
                                  </div>
                                </template>
                              </el-table-column>
                          </el-table>
    ...
    <el-dialog :title="dialogText" v-if="(menuButtonPermit.includes('Chinaphone_targetlistadd')||menuButtonPermit.includes('Chinaphone_targetlistedit'))&&device==='desktop'" custom-class="add-edit-dialog" :before-close="handleClose" :visible.sync="dialogFormVisible" width="440px">
      <el-form :model="dialogForm">
        ...
        <div class="item-form Compart-time-width">
            <el-form-item label="部门：" :label-width="formLabelWidth">
                <el-select v-model="dialogForm.group_id" clearable placeholder="请选择部门">
                    <el-option
...
export default {
  ...
  methods:{
      ...
      $this.$store.dispatch('api/getMenuButtonPermitAction',{id:$this.$router.currentRoute.meta.id}).then(res=>{
        if(res.status){
          if(res.data.length>0){
            ...
            if($this.menuButtonPermit.includes('Chinaphone_targetlist')){
              var operationsWidth = 22;
              if($this.menuButtonPermit.includes('Chinaphone_targetlistedit')){
                operationsWidth+=66;
              }
              if($this.menuButtonPermit.includes('Chinaphone_targetlistdelete')){
                operationsWidth+=66;
              }
    ...
    handleClose(){
      ...
      $this.$store.dispatch('app/closeCntargetlist');
    },
    // 添加表格行数据
    addTableRow(row,index){
      var $this = this;
      $this.dialogFormVisible = true;
      $this.dialogText = "添加日目标";
      $this.resetFormData();
    },
    // 编辑表格行数据
