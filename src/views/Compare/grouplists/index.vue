<template>
  <div class="page-root SaleCard" ref="boxPane">
                      ...
                      <div class="card-header SaleCard" ref="headerPane">
                          <div class="search-wrap Compart-search-wrap" ref="searchPane">          
                              ...
                              <div class="item-search" style="width:120px;">
                                <el-select v-model="searchData.dept_id" size="small" clearable placeholder="请选择小组">
                                  <el-option
                    ...
                    <div class="card-content" ref="tableContent">
                      <div class="table-wrapper" v-bind:class="scrollPosition.isFixed?'fixed-table':''">
                          ...
                          <el-table
                              ...
                              <el-table-column
                                v-if="(menuButtonPermit.indexOf('Compare_grouptargetedit')||menuButtonPermit.indexOf('Compare_grouptargetdelete'))"
                                ...
                                <template #default="scope">
                                  <div class="table-button">
                                    <el-button size="mini" @click="editTableRow(scope.row,scope.$index)" v-if="menuButtonPermit.includes('Compare_grouptargetedit')">编辑</el-button>
                                    <el-button size="mini" @click="deleteTableRow(scope.row,scope.$index)" v-if="menuButtonPermit.includes('Compare_grouptargetdelete')" type="info" plain>删除</el-button>
                                  </div>
                                </template>
                              </el-table-column>
                          </el-table>
      ...
      <el-dialog :title="dialogText" v-if="(menuButtonPermit.includes('Compare_grouptargetadd')||menuButtonPermit.includes('Compare_grouptargetedit'))" custom-class="add-edit-dialog" :before-close="handleClose" :visible.sync="dialogFormVisible" width="680px">
...
<script>
import { groupDealEdit,groupDealListAdd,groupDealListChoose,groupDealList,groupDealDel } from '@/api/Compare';
          ...
          if(response.status){
            if(response.data.length>0){
                ...
                response.data.forEach(function(item,index){
                  var itemData = {};
                  itemData.value = item.userid;
                  itemData.label = item.othername;
      ...
      $this.$store.dispatch('api/getMenuButtonPermitAction',{id:$this.$router.currentRoute.meta.id}).then(res=>{
        if(res.status){
          if(res.data.length>0){
            ...
            if($this.menuButtonPermit.includes('Compare_grouplists')){
              var operationsWidth = 22;
              if($this.menuButtonPermit.includes('Compare_grouptargetedit')){
                operationsWidth+=66;
              }
              if($this.menuButtonPermit.includes('Compare_grouptargetdelete')){
                operationsWidth+=66;
              }
