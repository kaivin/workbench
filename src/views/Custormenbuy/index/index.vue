                      ...
                      <div class="card-header SaleCard" ref="headerPane">
                          <div class="search-wrap Compart-search-wrap" ref="searchPane">          
                              ...
                              <div class="item-search">
                                ...
                                <el-button type="primary" plain class="resetBtn" size="small" v-if="menuButtonPermit.includes('Custormenbuy_exportlink')">
                                  <label>
...
<script>
import {deparDealListAdd,deparDealEdit,deparDealDel} from '@/api/Compare';
import {getCustormenbuyList,setExportLinken} from '@/api/Custormbuy';
import {EndeparDealListChoose} from '@/api/Encompare';
