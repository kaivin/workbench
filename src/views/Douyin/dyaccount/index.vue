<template>
  <div class="page-root" ref="boxPane">
              ...
              <div class="card-header" ref="headerPane">
                <div class="search-wrap" ref="searchPane">
                  ...
                  <div class="item-search">
                    ...
                    <el-button v-if="menuButtonPermit.includes('Douyin_dyadd')" type="success" size="small" icon="el-icon-plus" v-on:click="addTableRow()">新增账号</el-button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="table-wrapper" v-bind:class="scrollPosition.isFixed?'fixed-table':''">
                <div class="table-mask"></div>
                    <el-table
                      ...
                      <el-table-column
                        v-if="menuButtonPermit.includes('Douyin_dyedit')"
                        ...
                        <template #default="scope">
                          <div class="table-button">
                            <el-button size="mini" v-if="menuButtonPermit.includes('Douyin_dyedit')" @click="editTableRow(scope.row)" plain >编辑</el-button>
                          </div>
                        </template>
                      </el-table-column>
                    </el-table>
    ...
    <el-dialog :title="dialogText" v-if="menuButtonPermit.includes('Douyin_dyadd') || menuButtonPermit.includes('Douyin_dyedit')" custom-class="add-edit-dialog" :visible.sync="visible" :before-close="handleClose" width="500px">
      <el-form :model="dialogForm">
        <el-form-item label="抖音名称：" :label-width="formLabelWidth">
          <el-input v-model="dialogForm.name" ref="name" placeholder="请输入抖音名称" clearable></el-input>
        </el-form-item>
        <el-form-item label="部门名称：" :label-width="formLabelWidth">
          <el-input v-model="dialogForm.department" ref="department" placeholder="请输入部门名称"></el-input>
        </el-form-item>
        <el-form-item label="抖音负责人：" :label-width="formLabelWidth">
          <el-input v-model="dialogForm.uname" ref="uname" placeholder="请输入负责人姓名"></el-input>
        </el-form-item>
        <el-form-item label="抖音uid：" :label-width="formLabelWidth">
          <el-input v-model="dialogForm.uuid" ref="uuid" placeholder="请输入抖音uid"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
...
export default {
  ...
  methods:{
      ...
      $this.$store.dispatch('api/getMenuButtonPermitAction',{id:$this.$router.currentRoute.meta.id}).then(res=>{
        if(res.status){
          if(res.data.length>0){
            ...
            if($this.menuButtonPermit.includes('Douyin_dyaccount')){
                var operationsWidth = 22;
                if($this.menuButtonPermit.includes('Douyin_dyedit')){
                  operationsWidth+=66;
                }
    ...
    initPage(){
      ...
      $this.$store.dispatch('douyin/douyinAccountList',formData).then(response=>{
        if(response){
          if(response.status){
            if(response.data){
    ...
    saveData() {
      ...
      if(!$this.isSaveData){
        ...
        if($this.dialogForm.id){
          ...
          link="douyin/editDouyinAccount"
        }else{
          link="douyin/addDouyinAccount"
        }
