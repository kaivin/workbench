<template>
  <div class="page-root SaleCard" ref="boxPane">
    ...
    <el-dialog :title="dialogText" v-if="(menuButtonPermit.includes('Encompare_add')||menuButtonPermit.includes('Encompare_edit'))" custom-class="add-edit-dialog" :before-close="handleClose" :visible.sync="dialogFormVisible" width="440px">
