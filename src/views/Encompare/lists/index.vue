<template>
  <div class="page-root SaleCard" ref="boxPane">
                      ...
                      <div class="table-wrapper" v-bind:class="scrollPosition.isFixed?'fixed-table':''">
                        <div class="table-mask"></div>
                          <el-table
                              ...
                              <el-table-column
                                v-if="(menuButtonPermit.indexOf('Encompare_edit')||menuButtonPermit.indexOf('Encompare_delete'))&&device==='desktop'"
    ...
    <el-dialog :title="dialogText" v-if="(menuButtonPermit.includes('Encompare_add')||menuButtonPermit.includes('Encompare_edit'))&&device==='desktop'" custom-class="add-edit-dialog" :before-close="handleClose" :visible.sync="dialogFormVisible" width="440px">
