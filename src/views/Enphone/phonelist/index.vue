<template>
  <div class="page-root" ref="boxPane">
          ...
          <div class="scroll-panel" ref="scrollDom" style="will-change:scroll-position">
              <div class="true-height" ref="scrollPane">
                <div class="bread_top">
                  ...
                  <el-button type="primary" size="small" class="exportBtn derived" @click="showExportDialog" v-if="menuButtonPermit.includes('Enphone_otherlistexport')"><i class="svg-i"><svg-icon icon-class="derived" /></i>导出英文电话询盘</el-button>
                </div>
      ...
      <el-dialog title="导出英文电话询盘数据" v-if="menuButtonPermit.includes('Enphone_otherlistexport')" custom-class="export-dialog" :visible.sync="exportVisible" width="500px">
        <el-form>
          <div class="item-form">
