<template>
  <div class="page-root en-cn-product" ref="boxPane">
                    ...
                    <div class="card-content" ref="tableContent">
                      <div class="table-wrapper" v-bind:class="scrollPosition.isFixed?'fixed-table':''">
                          ...
                          <el-table
                            ...
                            <el-table-column
                              v-if="(menuButtonPermit.indexOf('Enphone_productedit')||menuButtonPermit.indexOf('Enphone_productdelete'))"
      ...
      <el-dialog :title="dialogText" v-if="(menuButtonPermit.includes('Enphone_productadd')||menuButtonPermit.includes('Enphone_productedit'))" custom-class="add-edit-dialog" :before-close="handleClose" :visible.sync="dialogFormVisible" width="440px">
...
export default {
  ...
  methods:{
    ...
    handleClose(){
      ...
      $this.$store.dispatch('app/closeEnProduct');
    },
    // 添加表格行数据
