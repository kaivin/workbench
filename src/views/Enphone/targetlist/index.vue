                      ...
                      <div class="card-header SaleCard" ref="headerPane">
                          <div class="search-wrap Compart-search-wrap" ref="searchPane">          
                              ...
                              <div class="item-search">
                                <el-button class="item-input" size="small" type="primary" icon="el-icon-search" :class="isSearchResult?'isDisabled':''" :disabled="isSearchResult" @click="searchResult">查询</el-button>
...
export default {
  ...
  methods:{
    ...
    handleClose(){
      ...
      $this.$store.dispatch('app/closeEntargetlist');
    },
    // 添加表格行数据
