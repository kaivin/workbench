<template>
  <div class="page-root SaleCard" ref="boxPane">
                    ...
                    <div class="card-content" ref="tableContent">
                      <div class="table-wrapper" v-bind:class="scrollPosition.isFixed?'fixed-table':''">
                          ...
                          <el-table
                              ...
                              <el-table-column
                                v-if="(menuButtonPermit.indexOf('Enuserscore_userscoreedit')||menuButtonPermit.indexOf('Enuserscore_userscoredelete'))"
                                ...
                                <template #default="scope">
                                  <div class="table-button">
                                    <el-button size="mini" @click="editTableRow(scope.row,scope.$index)" v-if="menuButtonPermit.includes('Enuserscore_userscoreedit')">编辑</el-button>
                                    <el-button size="mini" @click="deleteTableRow(scope.row,scope.$index)" v-if="menuButtonPermit.includes('Enuserscore_userscoredelete')" type="info" plain>删除</el-button>
                                  </div>
                                </template>
                              </el-table-column>
                          </el-table>
      ...
      <el-dialog :title="dialogText" v-if="(menuButtonPermit.includes('Enuserscore_userscoreadd')||menuButtonPermit.includes('Enuserscore_userscoreedit'))" custom-class="add-edit-dialog" :before-close="handleClose" :visible.sync="dialogFormVisible" width="400px">
...
export default {
  ...
  methods:{
      ...
      $this.$store.dispatch('api/getMenuButtonPermitAction',{id:$this.$router.currentRoute.meta.id}).then(res=>{
        if(res.status){
          if(res.data.length>0){
            ...
            if($this.menuButtonPermit.includes('Enuserscore_userscore')){
              var operationsWidth = 22;
              if($this.menuButtonPermit.includes('Enuserscore_userscoreedit')){
                operationsWidth+=66;
              }
              if($this.menuButtonPermit.includes('Enuserscore_userscoredelete')){
                operationsWidth+=66;
              }
    ...
    handleClose(){
      ...
      $this.$store.dispatch('app/closeEnScore');
    },
    // 添加表格行数据
