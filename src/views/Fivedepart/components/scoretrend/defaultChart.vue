  ...
  <div class="item-row depFive default-chart flex-box">
    <div class="item-column flex-box flex-column">
      ...
      <div class="column-body flex-content">
          <div class="item-tab pie-panel" v-show="currentType=='pie'">
            <div class="pie-chart" style="width:370px;height:517px; margin:0 auto;" :id="'pie-'+currentData.randomStr"></div>
          </div>
          <div class="item-tab rank-panel" v-show="currentType=='rank'">
            <div class="column-chart" style="width:370px;height:527px; margin:0 auto;" :id="'column-'+currentData.randomStr"></div>
          </div>
      </div>
    </div>
    <div class="flex-content flex-box flex-column">
      ...
      <div class="flex-content chart-content">
        <div v-if="currentData.chartType=='area'" style="height:550px;" class="chart-panel" :id="'area-'+currentData.randomStr"></div>
        <div v-else-if="currentData.chartType=='line'" style="height:550px;" class="chart-panel" :id="'line-'+currentData.randomStr"></div>
        <div v-else style="height:550px;" class="chart-panel" :id="'mulitColumn-'+currentData.randomStr"></div>
      </div>
    </div>
  </div>
</template>
...
<style scoped>
.depFive.item-row.default-chart{
