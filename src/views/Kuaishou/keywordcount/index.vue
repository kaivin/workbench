            ...
            <el-card class="box-card" shadow="hover">
              ...
              <div class="card-content" ref="tableContent">
                ...
                <div class="search_body">
                  <div class="seach_total"  :class="showXun && menuButtonPermit.includes('Kuaishou_xun') ? 'total_xun':''">
                    <el-popover
                      placement="top-start"
                      width="228"
                      trigger="hover">
                  ...
                  <el-tabs v-model="activeName" type="card" @tab-click="tabClick">
                    ...
                    <el-tab-pane label="询盘趋势" name="fifth" v-if="showXun && menuButtonPermit.includes('Kuaishou_xun')">
                      <div class="search_col">
                        <div class="search" v-if="isPopSearch"><p>请稍候...</p></div>
  ...
  export default {
    ...
    methods:{
      ...
      getUserMenuButtonPermit(){
        var $this = this;
        $this.$store.dispatch('api/getMenuButtonPermitAction',{id:164}).then(res=>{
          if(res.status){
      ...
      getKuaishouCount(){
        ...
        $this.$store.dispatch('kuaishou/kuaishouCountInfo', formData).then(response=>{
          if(response){
            if(response.status){
      ...
      getColumnRes(){
        ...
        formData.start_num = $this.popSearch.start_num;
        formData.end_num = $this.popSearch.end_num;
        $this.$store.dispatch('kuaishou/kuaishouWordInfo', formData).then(response=>{
          if(response){
            $this.columnData = {};
            if(response.status){
