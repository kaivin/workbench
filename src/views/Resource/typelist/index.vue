                            ...
                            <el-table-column
                              ...
                              <template #default="scope">
                                <div class="table-button">
                                  <el-button size="mini" @click="editTableRow(scope.row,scope.$index)" v-if="scope.row.isPermit&&menuButtonPermit.includes('Resource_typeedit')">编辑</el-button>
                                  <el-button size="mini" @click="deleteTableRow(scope.row,scope.$index)" v-if="scope.row.isPermit&&menuButtonPermit.includes('Resource_typedelete')" type="info" plain>删除</el-button>
                                </div>
                              </template>
                            </el-table-column>
                          </el-table>
