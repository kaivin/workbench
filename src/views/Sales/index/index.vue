...
export default {
  ...
  created(){
    ...
    if($this.$route.query.Status){
        ...
        $this.$router.push({path:`/Sales/index?Status=personcount`});
    }
  ...
  methods:{
    ...
    setScrollDom(){
      ...
      if($this.$refs.headerPane){
         $this.scrollTable.fixedTopHeight = $this.$refs.headerPane.offsetHeight+$this.$refs.breadcrumbPane.offsetHeight+3;
      }else{
         $this.scrollTable.fixedTopHeight=$this.$refs.breadcrumbPane.offsetHeight+3;
      }
      ...
      if($this.totalDataNum>20){
        ...
        if(scrTop+$this.scrollTable.clientHeight>=$this.scrollTable.tableBottom-20){
          $this.scrollPosition.fixedBottom = scrTop+$this.scrollTable.clientHeight-$this.scrollTable.tableBottom-40;
        }else{
