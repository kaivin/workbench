<template>
  <div class="page-root" ref="boxPane">
                    ...
                    <div class="card-content" ref="tableContent">
                      <div class="table-wrapper" v-bind:class="scrollPosition.isFixed?'fixed-table':''">
                            ...
                            <el-table
                              ...
                              <el-table-column
                                v-if="(menuButtonPermit.includes('Tableconfig_getrole'))&&device==='desktop'"
                                ...
                                <template #default="scope">
                                  <div class="table-button">
                                    <el-button size="mini" @click="allotRole(scope.row,scope.$index)" v-if="menuButtonPermit.includes('Tableconfig_getrole')">分配角色</el-button>
                                  </div>
                                </template>
                              </el-table-column>
                            </el-table>
    ...
    <el-dialog title="分配角色" v-if="(menuButtonPermit.includes('Tableconfig_getrole'))&&device==='desktop'" custom-class="transfer-dialog" :visible.sync="dialogRoleVisible" width="840px">
      ...
      $this.$store.dispatch('api/getMenuButtonPermitAction',{id:$this.$router.currentRoute.meta.id}).then(res=>{
        ...
        if(res.status){
          if(res.data.length>0){
            ...
            if($this.menuButtonPermit.includes('Tableconfig_index')){
              var operationsWidth = 22;
              if($this.menuButtonPermit.includes('Tableconfig_getrole')){
                operationsWidth+=90;
              }
