<template>
  <div class="page-root SaleCard" ref="boxPane">
                      ...
                      <div class="card-header SaleCard" ref="headerPane">
                          <div class="search-wrap Compart-search-wrap" ref="searchPane">          
                              ...
                              <div class="item-search">
                                  <el-select size="small" filterable v-model="searchData.userid" clearable placeholder="请选择用户">
                                    <el-option
                              ...
                              <div class="item-search">
                                ...
                                <el-button type="primary" plain class="resetBtn" size="small" v-if="menuButtonPermit.includes('User_exportlink')">
                                  <label>
                    ...
                    <div class="card-content" ref="tableContent">
                      <div class="table-wrapper" v-bind:class="scrollPosition.isFixed?'fixed-table':''">
                          ...
                          <el-table
                              ...
                              <el-table-column
                                v-if="(menuButtonPermit.indexOf('User_personotheredit'))"
                                ...
                                <template #default="scope">
                                  <div class="table-button">
                                    <el-button size="mini" @click="editTableRow(scope.row,scope.$index)" v-if="menuButtonPermit.includes('User_personotheredit')">编辑</el-button>
                                  </div>
                                </template>
                              </el-table-column>
                          </el-table>
      ...
      <el-dialog :title="dialogText" v-if="(menuButtonPermit.includes('User_personotheradd')||menuButtonPermit.includes('User_personotheredit'))" custom-class="add-edit-dialog" :before-close="handleClose" :visible.sync="dialogFormVisible" width="680px">
          ...
          <div class="item-form-group">
              <div class="item-form Compart-time-width">
                  <el-form-item label="用户" :label-width="formLabelWidth">
                      <el-select filterable v-model="dialogForm.uid" clearable placeholder="请选择用户">
                          <el-option
                              v-for="item in deptList"
                              :key="item.value"
                              :label="item.label"
...
export default {
  ...
  methods:{
    ...
    restearch(){
      ...
      formData.userid = $this.searchData.userid;
      ...
      $this.$store.dispatch('api/getMenuButtonPermitAction',{id:$this.$router.currentRoute.meta.id}).then(res=>{
        if(res.status){
          if(res.data.length>0){
            ...
            if($this.menuButtonPermit.includes('User_personother')){
              var operationsWidth = 22;
              if($this.menuButtonPermit.includes('User_personotheredit')){
                operationsWidth+=66;
              }
