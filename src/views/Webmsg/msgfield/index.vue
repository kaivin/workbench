                          ...
                          <el-table
                            ...
                            <el-table-column
                              ...
                              <template #default="scope">
                                <el-button size="mini" @click="allotRole(scope.row,scope.$index)" v-if="menuButtonPermit.includes('Webmsg_getrole')">分配角色</el-button>
                              </template>
                            </el-table-column>
                          </el-table>
                      </div>
      ...
      $this.$store.dispatch('api/getMenuButtonPermitAction',{id:$this.$router.currentRoute.meta.id}).then(res=>{
        ...
        if(res.status){
          if(res.data.length>0){
            ...
            if($this.menuButtonPermit.includes('Webmsg_msgfield')){
              var operationsWidth = 20;
              if($this.menuButtonPermit.includes('Webmsg_getrole')){
                operationsWidth += 90;
              }
