<template>
  <div class="page-root" ref="boxPane">
    ...
    <el-dialog title="分配角色" v-if="(menuButtonPermit.includes('Website_getfieldreadrole')||menuButtonPermit.includes('Website_getfieldwriterole'))&&device==='desktop'" custom-class="user-dialog" :visible.sync="dialogRoleVisible" width="840px">
      <div class="user-role">
        <div class="role-wrap">
          <el-transfer 
            v-model="roleValue" 
