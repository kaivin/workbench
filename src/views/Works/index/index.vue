<template>
  <div class="page-root tags-index" ref="boxPane">
                    ...
                    <div class="card-content" ref="tableContent">
                      <div class="table-wrapper" v-bind:class="scrollPosition.isFixed?'fixed-table':''">
                            ...
                            <el-table
                              ...
                              <el-table-column
                                v-if="(menuButtonPermit.includes('Works_edit')||menuButtonPermit.includes('Works_delete'))"
                                ...
                                <template #default="scope">
                                  <div class="table-button">
                                    <el-button size="mini" @click="editTableRow(scope.row,scope.$index)" v-if="menuButtonPermit.includes('Works_edit')">编辑</el-button>
                                    <el-button size="mini" @click="deleteTableRow(scope.row,scope.$index)" v-if="menuButtonPermit.includes('Works_delete')" type="info" plain>删除</el-button>
                                  </div>
                                </template>
                              </el-table-column>
                            </el-table>
      ...
      <el-dialog :title="dialogText" v-if="(menuButtonPermit.includes('Works_add')||menuButtonPermit.includes('Works_edit'))" custom-class="add-edit-dialog" :visible.sync="dialogFormVisible" :before-close="handleClose" width="480px">
...
export default {
  ...
  methods:{
      ...
      $this.$store.dispatch('api/getMenuButtonPermitAction',{id:$this.$router.currentRoute.meta.id}).then(res=>{
        if(res.status){
          if(res.data.length>0){
            ...
            if($this.menuButtonPermit.includes('Works_index')){
              var operationsWidth = 22;
              if($this.menuButtonPermit.includes('Works_edit')){
                operationsWidth+=66;
              }
              if($this.menuButtonPermit.includes('Works_delete')){
                operationsWidth+=66;
              }
    ...
    handleClose(){
      ...
      $this.$store.dispatch('app/closeWorkOrderTag');
    },
    // 添加表格行数据
